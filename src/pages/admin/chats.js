...
export default function Chats() {
  ...
  // Mobile view state
  const [activeTier, setActiveTier] = useState(1); // 1 = Users, 2 = Studies, 3 = Messages
  ...
  const handleSelectUser = (user) => {
    ...
    // Move to Studies tier on mobile
  ...
  const handleSelectStudy = (study) => {
    ...
    // Move to Messages tier on mobile
    if (window.innerWidth < 1024) {
      setActiveTier(3);
    }
  };
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Three-tier Chat Layout - Desktop */}
                            ...
                            <div 
                              className={`flex items-start space-x-2 ${
                                message.adminsender_id 
                                  ...
                                  : 'bg-gray-100 mr-auto'
                              } rounded-lg p-3 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg`}
                            >
          ...
          {/* Three-tier Chat Layout - Mobile Sliding Panels */}
          <div className="lg:hidden flex flex-1 overflow-hidden relative">
            {/* Mobile Users Column - First Tier */}
            <div 
              className={`absolute inset-0 bg-white w-full h-full transition-transform duration-300 ease-in-out ${
                activeTier === 1 ? 'translate-x-0' : 
                activeTier === 2 ? '-translate-x-full' : '-translate-x-full'
              } overflow-y-auto`}
            >
              <div className="p-4">
                <div className="flex justify-between items-center mb-4">
                  ...
                  {selectedUser && (
                    <button 
                      ...
                      className="flex items-center text-indigo-600 px-2 py-1 rounded"
                    >
                      Studies <ChevronRight className="w-4 h-4 ml-1" />
                    </button>
                  )}
                </div>
            ...
            {/* Mobile Studies Column - Second Tier */}
            <div 
              className={`absolute inset-0 bg-white w-full h-full transition-transform duration-300 ease-in-out ${
                activeTier === 2 ? 'translate-x-0' : 
                activeTier === 1 ? 'translate-x-full' : '-translate-x-full'
              } overflow-y-auto`}
            >
              <div className="p-4">
                <div className="flex justify-between items-center mb-4">
                  <button 
                    ...
                    className="flex items-center text-indigo-600 px-2 py-1 rounded"
                  >
                    <ChevronLeft className="w-4 h-4 mr-1" /> Users
                  </button>
                  ...
                  {selectedStudy && (
                    <button 
                      ...
                      className="flex items-center text-indigo-600 px-2 py-1 rounded"
                    >
                      Messages <ChevronRight className="w-4 h-4 ml-1" />
                    </button>
                  )}
                </div>
            ...
            {/* Mobile Messages Column - Third Tier */}
            <div 
              className={`absolute inset-0 bg-white w-full h-full transition-transform duration-300 ease-in-out ${
                activeTier === 3 ? 'translate-x-0' : 
                activeTier === 2 ? 'translate-x-full' : 'translate-x-full'
              } flex flex-col`}
            >
              <div className="p-4 flex-1 overflow-y-auto">
                <div className="flex justify-between items-center mb-4">
                  <button 
                    ...
                    className="flex items-center text-indigo-600 px-2 py-1 rounded"
                  >
                    <ChevronLeft className="w-4 h-4 mr-1" /> Studies
                  </button>
              ...
              {/* Message Input Area - Keep Original Format */}
              {selectedStudy && (
                <div className="p-4 border-t border-gray-200">
                  <div className="flex space-x-4">
                    <div className="flex-1">
