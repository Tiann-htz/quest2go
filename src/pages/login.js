...
<AnimatePresence>
  {showSuccessAlert && (
    <motion.div
      className="fixed top-0 inset-x-0 flex items-center justify-center px-4 py-6 pointer-events-none z-30"
      initial={{ opacity: 0, y: -50 }}
      animate={{ opacity: 1, y: 0 }}
      exit={{ opacity: 0, y: -50 }}
      transition={{ duration: 0.5 }}
    >
      <div className="max-w-md w-full bg-green-50 shadow-lg rounded-lg pointer-events-auto ring-1 ring-green-200 overflow-hidden">
        <div className="p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4 flex-1">
              <p className="text-lg font-medium text-green-800">Login successful!</p>
