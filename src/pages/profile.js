...
const [showPasswordTooltip, setShowPasswordTooltip] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const showTooltip = (setTooltipState) => {
...
<div>
  <label htmlFor="password" className="block text-sm font-medium text-gray-700 flex items-center">
    ...
    <button
      type="button"
      onClick={() => showTooltip(setShowPasswordTooltip)}
    ...
    {showPasswordTooltip && (
      <div className="absolute ml-24 z-10 mt-14 w-72 rounded-md shadow-lg bg-gray-800 ring-1 ring-black ring-opacity-5 p-4 transition-opacity duration-300">
        <p className="text-sm text-white">
          You can change your password once every 5 minutes after resetting it.
        </p>
      </div>
    )}
  </label>
  ...
  <div className="flex items-center">
    ...
    <button
      type="button"
      onClick={() => showTooltip(setShowAccountTooltip)}
      className="text-gray-500 hover:text-gray-700 ml-2"
    >
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    ...
    {showAccountTooltip && (
      <div className="absolute left-40 top-10 z-10 mt-2 w-72 rounded-md shadow-lg bg-gray-800 ring-1 ring-black ring-opacity-5 p-4 transition-opacity duration-300">
        <p className="text-sm text-white">
